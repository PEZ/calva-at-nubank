...
Before writing or planning Babashka code, establish a REPL connection:

1. Use `clojure_list_sessions` to look for a session named `bb` or `babashka`
2. If found: use it for exploration and validation
3. If not found: ask the user whether to start one or work without

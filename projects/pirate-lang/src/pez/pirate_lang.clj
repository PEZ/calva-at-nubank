...
(tests
  (to-pirate-talk "Hello" english-o) := "HoHelollolo"
  (from-pirate-talk "HoHelollolo" english-o) := "Hello"

  (to-pirate-talk "Pirate" english-o) := "PoPiroratote"
  (from-pirate-talk "PoPiroratote" english-o) := "Pirate"

  (to-pirate-talk "aeiou" english-o) := "aeiou"
  (from-pirate-talk "aeiou" english-o) := "aeiou")
...
(comment
  {:pirate     "Blackbeard"
   ...
   :provisions {:rum     3/4
                :gold    1337.0
                :parrot  nil}
   :skills     ["swordfighting" "navigation" "plundering"]
   :log        '(2026 :set-sail {:port "Tortuga" :dangers #{:kraken :navy :scurvy}})
   :coords     [13.37 -42.0]
   :flag       \☠}
